        ...
        children={
          <>
            ...
            <div className="card-with-menu__navbar">
              <NavLink onClick={handleNavClick} to={`${props.url}/kit`} activeClassName={`card-with-menu__link-btn_active`} className={`card__link-btn card__link-btn_level_${props.level} card-with-menu__link-btn card-with-menu__link-btn_rotate`}>
                <p className="card-with-menu__rotate-btn-text">Комплектация</p>
              </NavLink>
              <NavLink onClick={handleNavClick} to={`${props.url}/specifications`} activeClassName={`card-with-menu__link-btn_active`} className={`card__link-btn card__link-btn_level_${props.level} card-with-menu__link-btn`}>Тех.<br /> характеристики</NavLink>
