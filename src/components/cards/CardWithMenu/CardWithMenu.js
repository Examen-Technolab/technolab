        ...
        children={
          <>
            ...
            <div className="card-with-menu__navbar">
              <NavLink to={`${props.url}/specifications`} activeClassName={`card-with-menu__link-btn_active`} className={`card__link-btn card__link-btn_level_${props.card.type} card-with-menu__link-btn card-with-menu__link-btn_rotate`}>
                <p className="card-with-menu__rotate-btn-text">Описание</p>
              </NavLink>
              <NavLink to={`${props.url}/kit`} activeClassName={`card-with-menu__link-btn_active`} className={`card__link-btn card__link-btn_level_${props.card.type} card-with-menu__link-btn`}>Комплектация</NavLink>
              <NavLink to={`${props.url}/characteristic`} activeClassName={`card-with-menu__link-btn_active`} className={`card__link-btn card__link-btn_level_${props.card.type} card-with-menu__link-btn card-with-menu__link-btn_rotate`}>
